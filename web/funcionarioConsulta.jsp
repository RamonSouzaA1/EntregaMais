...
<html>
    ...
    <body>
        ...
        <div id="main" class="container-fluid">
         <h3 class="page-header">Consulta de Funcionarios</h3>
        ...
        <table class="table table-bordered table-hover">
            ...
            <c:forEach items="${funcionarios}" var="funcionario">
                <tr>
                    ...
                    <td><c:out value="${funcionario.logradouro}"></c:out></td>
    ...
    <div id="actions" class="row">
     <div class="col-md-12">
      <a href="funcionarioAdicionar.jsp" class="btn btn-primary">Adicionar</a>
      <a href="funcionarioEditar.jsp" class="btn btn-success">Editar</a>
      <a href="funcionarioApagar.jsp" class="btn btn-danger">Apagar</a>
