...
<html>
    ...
    <body>
        ...
        <div id="main" class="container-fluid">
         <h3 class="page-header">Consulta de Clientes CNPJ</h3>
    ...
    <div id="actions" class="row">
     <div class="col-md-12">
      <a href="clienteCNPJAdicionar.jsp" class="btn btn-primary">Adicionar</a>
      <a href="clienteCNPJEditar.jsp" class="btn btn-success">Editar</a>
      <a href="clienteCNPJApagar.jsp" class="btn btn-danger">Apagar</a>
